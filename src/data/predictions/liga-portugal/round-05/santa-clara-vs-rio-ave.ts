...
export const santaClaraVsRioAve: EditorialPrediction = {
  league: "liga-portugal",
  homeTeam: "Santa Clara",
  awayTeam: "Rio Ave",
  slug: "santa-clara-vs-rio-ave",
...
`
  ...
  picks: {
    main: "Santa Clara or Draw (1X) + Over 1.5 Goals",
    publishedOdds: 1.62,
    oddsProvenance: {
      source: "Author-supplied approved editorial package",
      provenance: "author_attested",
      market: "Santa Clara or Draw (1X) + Over 1.5 Goals"
    }
  },
