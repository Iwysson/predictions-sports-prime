...
export const alvercaVsSantaClara: EditorialPrediction = {
  league: "liga-portugal",
  homeTeam: "Alverca",
  awayTeam: "Santa Clara",
  analysis: [
    "Alverca host Santa Clara in Liga Portugal. This preview is intentionally limited to the verified fixture and the structure of the supplied editorial selection: Santa Clara or Draw (X2) + Under 3.5 Goals.",
    ...
    "The selection is match-specific because it assigns the relevant protection, scoring line, or winning requirement to Alverca and Santa Clara exactly as shown. It should be assessed as one complete betting position rather than as a claim that either side is certain to produce a particular performance.",
  ...
  picks: {
    main: "Santa Clara or Draw (X2) + Under 3.5 Goals",
    odds: 1.83,
    oddsProvenance: {
      source: "Betano — author-attested editorial capture",
      bookmaker: "Betano",
      provenance: "author_attested",
      capturedAt: "2026-08-24T13:24:00-03:00",
      market: "Santa Clara or Draw (X2) + Under 3.5 Goals",
    },
  },
