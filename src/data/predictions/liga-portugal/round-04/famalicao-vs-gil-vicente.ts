...
export const famalicaoVsGilVicente: EditorialPrediction = {
  league: "liga-portugal",
  homeTeam: "Famalicao",
  awayTeam: "Gil Vicente",
  analysis: [
    "Famalicao host Gil Vicente in Liga Portugal. This preview is intentionally limited to the verified fixture and the structure of the supplied editorial selection: Over 1.5 Goals — Live Entry.",
    "the goals component makes the total scoring range part of the selection.",
    "The selection is match-specific because it assigns the relevant protection, scoring line, or winning requirement to Famalicao and Gil Vicente exactly as shown. It should be assessed as one complete betting position rather than as a claim that either side is certain to produce a particular performance.",
  ...
  comment: "Pre-Match Odds: 1.43. Preferred Entry: 1.65+ live. Live Entry Only. Target Odds: 1.65+.",
  picks: {
    ...
    liveEntryProvenance: {
      ...
      preMatchOdds: 1.43,
      capturedAt: "2026-08-24T13:31:00-03:00",
    },
  },
