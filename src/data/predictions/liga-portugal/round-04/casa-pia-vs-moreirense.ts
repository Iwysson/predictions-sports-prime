...
export const casaPiaVsMoreirense: EditorialPrediction = {
  league: "liga-portugal",
  homeTeam: "Casa Pia",
  awayTeam: "Moreirense",
  analysis: [
    "Casa Pia host Moreirense in Liga Portugal. This preview is intentionally limited to the verified fixture and the structure of the supplied editorial selection: Over 1.5 Goals — Live Entry.",
    "the goals component makes the total scoring range part of the selection.",
    "The selection is match-specific because it assigns the relevant protection, scoring line, or winning requirement to Casa Pia and Moreirense exactly as shown. It should be assessed as one complete betting position rather than as a claim that either side is certain to produce a particular performance.",
  ...
  picks: {
    ...
    liveEntryProvenance: {
      ...
      preMatchOdds: 1.44,
      capturedAt: "2026-08-24T13:30:00-03:00",
    },
  },
