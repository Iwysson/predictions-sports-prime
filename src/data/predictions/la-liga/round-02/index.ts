...
import { getafeVsRealRacingClubDeSantander } from "./getafe-vs-real-racing-club-de-santander";
import { rcdEspanyolDeBarcelonaVsRealMadrid } from "./rcd-espanyol-de-barcelona-vs-real-madrid";
import { atleticoMadridVsVillarreal } from "./atletico-madrid-vs-villarreal";
import { realBetisVsRealSociedad } from "./real-betis-vs-real-sociedad";
...
export const laLigaRound02 = [
  ...
  getafeVsRealRacingClubDeSantander,
  rcdEspanyolDeBarcelonaVsRealMadrid,
  atleticoMadridVsVillarreal,
  realBetisVsRealSociedad,
];
