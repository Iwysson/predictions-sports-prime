...
Inter and Napoli both arrive with maximum points from their opening HOME/AWAY references, so this is not a case where the table alone separates them. The useful distinction is Inter's home scoring efficiency against a Napoli away profile that has already combined a clean sheet with controlled shot suppression.
