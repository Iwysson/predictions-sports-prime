...
export const georgiaVsUkraine: EditorialPrediction = {
  league: "uefa-nations-league-b",
  homeTeam: "Georgia",
  awayTeam: "Ukraine",
  slug: "georgia-vs-ukraine",
  title: "Georgia vs Ukraine Prediction, Odds and Betting Tips",
  analysis: [`# Georgia vs Ukraine Prediction, Odds and Betting Tips
...
**Competition:** UEFA Nations League B 2026/27 | **Date:** 2026-09-28 | **Kick-off:** 18:00 | **Round:** Matchday 2  
**Venue/location:** Tbilisi

### Team news, availability and recent form

Georgia's second home match of the Nations League window comes only three days after the opener against Northern Ireland. That schedule makes rotation and recovery central to the pre-match picture. The established Georgian core still starts with Giorgi Mamardashvili in goal and runs through Otar Kakabadze, Luka Lochoshvili, Giorgi Kochorashvili, Otar Kiteishvili, Zuriko Davitashvili, Khvicha Kvaratskhelia and Georges Mikautadze. Anzor Mekvabishvili has been added to the September group, giving the midfield another option for a window in which Georgia have to play twice in four days.
...
**Rotation note:** Mekvabishvili is a realistic starter if Georgia want to protect midfield legs after Northern Ireland, while Zivzivadze can change the centre-forward role.
...
**Rotation note:** Yaremchuk, Pikhalyonok and Yarmolenko can all enter depending on the minutes played in Hungary. The absence of Dovbyk is confirmed before the window.

### Head-to-head and tactical analysis

The H2H strongly favours Ukraine historically. The teams have met 11 times, with Ukraine winning seven and the other four ending in draws; Georgia have never beaten Ukraine at senior level. The most recent competitive pair came in the 2024/25 Nations League. Ukraine won the first 1-0 and the return match in Georgia finished 1-1. That makes the current game more relevant than the older meetings because several of the principal players remain important for both teams.
...
|---|---:|---:|
| Nations League B2 record before MD1 | 0-0-0 | 0-0-0 |
| Previous match | Northern Ireland, 25 Sep | Hungary, 25 Sep |
| Major squad note | Mekvabishvili in camp | Dovbyk/Andrievskyi out |
| Main attacking references | Kvaratskhelia, Mikautadze | Sudakov, Tsygankov, Vanat/Yaremchuk |
| All-time H2H | 0 wins, 4 draws | 7 wins, 4 draws |

### Market price and value

Ukraine's unbeaten historical record in this matchup and the passing quality of Sudakov and Tsygankov are substantial risks if Georgia's wing-backs leave the outside centre-backs exposed.

At published odds of **1.57**, the raw implied probability is **63.7%**, calculated as 1 / 1.57 before bookmaker margin. That percentage is the market price, not a historical hit rate or a PSP forecast; value depends on the match-specific evidence and the stated risk.
...
**Odds:** 1.57`],
  ...
  matchSeo: {
    lineups: {
      ...
      sources: [{"name":"UAF — Changes to the Ukraine squad","url":"https://uaf.ua/en/news/changes-to-the-composition-of-the-ukraine-national-team-2","accessedAt":"2026-09-20T18:49:50-03:00"}],
