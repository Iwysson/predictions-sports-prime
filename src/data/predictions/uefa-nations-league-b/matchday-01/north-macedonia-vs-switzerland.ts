...
export const northMacedoniaVsSwitzerland: EditorialPrediction = {
  league: "uefa-nations-league-b",
  homeTeam: "North Macedonia",
  awayTeam: "Switzerland",
  slug: "north-macedonia-vs-switzerland",
  title: "North Macedonia vs Switzerland Prediction, Odds and Betting Tips",
  analysis: [`# North Macedonia vs Switzerland Prediction, Odds and Betting Tips
...
**Competition:** UEFA Nations League B 2026/27 | **Date:** 2026-09-26 | **Kick-off:** 20:45 | **Round:** Matchday 1  
**Venue/location:** National Arena Todor Proeski, Skopje

### Team news, availability and recent form

North Macedonia begin their Nations League campaign in Skopje with a 28-man squad selected by Goce Sedloski for a demanding four-match block. Stole Dimitrievski, Damjan Shishkovski and Davor Taleski are the goalkeepers. The defensive list includes Gjoko Zajkov, Visar Musliu, Mario Mladenovski, Bojan Ilievski, Andrej Stojchevski, Sebastian Herrera, Ezgjan Alioski, Din Alomerović and two of the new faces, Anes Meliqi and Gjorgje Dzekov.

The midfield still contains the two best-known creative players, Elif Elmas and Enis Bardhi, alongside Jani Atanasov, Agon Elezi, Boban Nikolov, Luka Stankovski, Tihomir Kostadinov, Ljupche Doriev, Darko Churlinov, Dimitar Mitrovski and debutant Matej Gashtarov. Bojan Miovski leads the forward options with Elmin Rastoder, Azer Omeragić and debutant Hristijan Maleski. The federation confirmed that defender Nikola Serafimov misses the window through injury.
...
There is no established senior H2H series between North Macedonia and Switzerland to use as a meaningful trend. The lack of previous meetings makes current form and squad level more informative. North Macedonia's home crowd will make the opening phase intense, but Switzerland have recently dealt with much higher-tempo tournament matches and are unlikely to be surprised by an aggressive first 15 minutes.

The tactical challenge for the hosts is to keep Elmas and Bardhi close enough to Miovski without exposing the centre in transition. If they drop too deep, Miovski can become isolated against Akanji and Elvedi. If they push both midfield creators forward, Freuler and his midfield partner have space to control the next phase. Switzerland, meanwhile, need patience if North Macedonia defend with five across the back line.
...
| Current indicator | North Macedonia | Switzerland |
|---|---:|---:|
...
North Macedonia's crowd, Bardhi's set pieces and the intensity of a first-ever meeting offer the hosts a route to make a short away price fragile.

At published odds of **1.42**, the raw implied probability is **70.4%**, calculated as 1 / 1.42 before bookmaker margin. That percentage is the market price, not a historical hit rate or a PSP forecast; value depends on the match-specific evidence and the stated risk.
...
**Odds:** 1.42`],
  ...
  sources: [
    ...
    {"name":"Swiss FA — Switzerland Nations League squad","url":"https://www.football.ch/en/desktopdefault.aspx/tabid-2509/8520_read-281212/","description":"Official 25-player squad and post-World Cup changes.","accessedAt":"2026-09-20T18:49:50-03:00"},
    {"name":"Swiss FA — match calendar","url":"https://football.ch/sfv/nationalteams/a-team/kalender.aspx","description":"Official kick-off and venue listing.","accessedAt":"2026-09-20T18:49:50-03:00"}
  ],
  matchSeo: {
    lineups: {
      status: "expected",
