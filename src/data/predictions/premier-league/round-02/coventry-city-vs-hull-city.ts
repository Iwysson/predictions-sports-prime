...
export const coventryCityVsHullCity: EditorialPrediction = {
  league: "premier-league",
  homeTeam: "Coventry City",
  awayTeam: "Hull City",
  analysis: [
    "Coventry City host Hull City in Premier League. This preview is intentionally limited to the verified fixture and the structure of the supplied editorial selection: Coventry City or Draw (1X) + Over 1.5 Goals.",
    ...
    "The selection is match-specific because it assigns the relevant protection, scoring line, or winning requirement to Coventry City and Hull City exactly as shown. It should be assessed as one complete betting position rather than as a claim that either side is certain to produce a particular performance.",
  ...
  picks: {
    main: "Coventry City or Draw (1X) + Over 1.5 Goals",
    odds: 1.6,
    oddsProvenance: {
      source: "Betano — author-attested editorial capture",
      bookmaker: "Betano",
      provenance: "author_attested",
      capturedAt: "2026-08-24T12:33:00-03:00",
      market: "Coventry City or Draw (1X) + Over 1.5 Goals",
    },
  },
