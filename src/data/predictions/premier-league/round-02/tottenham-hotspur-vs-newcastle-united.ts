...
export const tottenhamHotspurVsNewcastleUnited: EditorialPrediction = {
  league: "premier-league",
  homeTeam: "Tottenham Hotspur",
  awayTeam: "Newcastle United",
  analysis: [
    "Tottenham Hotspur host Newcastle United in Premier League. This preview is intentionally limited to the verified fixture and the structure of the supplied editorial selection: Over 2.5 Goals.",
    "the goals component makes the total scoring range part of the selection.",
    "The selection is match-specific because it assigns the relevant protection, scoring line, or winning requirement to Tottenham Hotspur and Newcastle United exactly as shown. It should be assessed as one complete betting position rather than as a claim that either side is certain to produce a particular performance.",
  ...
  picks: {
    ...
    oddsProvenance: {
      ...
      capturedAt: "2026-08-24T12:34:00-03:00",
