...
export const bournemouthVsEverton: EditorialPrediction = {
  league: "premier-league",
  homeTeam: "Bournemouth",
  awayTeam: "Everton",
  analysis: [
    "Bournemouth host Everton in Premier League. This preview is intentionally limited to the verified fixture and the structure of the supplied editorial selection: Bournemouth or Draw (1X) + Over 1.5 Goals.",
    ...
    "The selection is match-specific because it assigns the relevant protection, scoring line, or winning requirement to Bournemouth and Everton exactly as shown. It should be assessed as one complete betting position rather than as a claim that either side is certain to produce a particular performance.",
  ...
  picks: {
    main: "Bournemouth or Draw (1X) + Over 1.5 Goals",
    odds: 1.67,
    oddsProvenance: {
      source: "Betano — author-attested editorial capture",
      bookmaker: "Betano",
      provenance: "author_attested",
      capturedAt: "2026-08-24T12:31:00-03:00",
      market: "Bournemouth or Draw (1X) + Over 1.5 Goals",
    },
  },
