...
export const newcastleUnitedVsBournemouth: EditorialPrediction = {
  league: "premier-league",
  homeTeam: "Newcastle United",
  awayTeam: "Bournemouth",
  slug: "newcastle-united-vs-bournemouth",
  analysis: [
    `# Newcastle United vs Bournemouth Prediction, Odds and Betting Tips
...
| Metric | Newcastle United — HOME | Bournemouth — AWAY |
| --- | ---: | ---: |
| Matches (N) | 1 | 1 |
| W-D-L | 0-1-0 | 0-0-1 |
...
| Shots/game | 13.0 | 5.0 |
| SOT/game | 4.0 | 4.0 |
| Shots allowed/game | 27.0 | 13.0 |
| SOT allowed/game | 7.0 | 6.0 |
| Possession | 39% | 34% |
| Corners for/game | 2.0 | 3.0 |
| Corners against/game | 6.0 | 8.0 |
| Total corners/game | 8.0 | 11.0 |
...
`
  ...
  sources: [
    {
        "name": "xGscore — Newcastle 2-2 Liverpool",
        "url": "https://xgscore.io/epl/newcastle-liverpool/xg-statistics",
    ...
    {
        "name": "Starting11 — Newcastle vs Bournemouth",
