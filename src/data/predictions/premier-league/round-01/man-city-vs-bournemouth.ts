...
export const manchesterCityVsBournemouth: EditorialPrediction = {
  ...
  "Manchester City-Bournemouth has one limit on the available evidence: England 2025/26 final tables records the completed competition but cannot substantiate the old granular statistical and team-news claims, which are omitted rather than reconstructed.",

  "Manchester City versus Bournemouth retains the published selection, Manchester City -1.5 Asian Handicap, as part of its pre-match record; this page uses no eventual result and does not claim that the available evidence independently proves the pick.",
