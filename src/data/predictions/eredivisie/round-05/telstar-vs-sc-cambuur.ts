...
export const telstarVsScCambuur: EditorialPrediction = {
  league: "eredivisie",
  homeTeam: "Telstar",
  awayTeam: "SC Cambuur",
  slug: "telstar-vs-sc-cambuur",
  title: "Telstar vs SC Cambuur Prediction",
  seoTitle: "Telstar vs SC Cambuur Prediction & Match Analysis",
  analysis: [
    `# Telstar vs SC Cambuur Prediction, Odds and Betting Tips

**Prediction:** Telstar to Win
**Odds:** 1.62
...
**Kickoff:** 14:30
**Round:** Matchweek 5
**Venue:** Rabobank IJmond Stadion

### Team News / Availability
Essa diferença de divisão é fundamental: os números longos do Cambuur precisam ser ajustados porque foram produzidos contra oposição de nível inferior, enquanto os do Telstar vieram da própria Eredivisie. **Provável Cambuur (4-3-3): Thijs Jansen; Lucas Jetten, Jamal Amofa, Ismaël Baouf, Billy van Duijl; Nicky Souren, Jorn Berkhout, Rafik El Arguioui; Iwan Henstra (Ilyes Hamache), Sami Bouhoudane (Nicolas Binder), Morgan Costarelli (Fabian Kvam).** **Daan Visser** permanece entre os nomes ausentes por problema no joelho. O Telstar começou vencendo o NEC por **2–1 fora**, depois perdeu **3–1 para o Sparta Rotterdam** e **4–0 para o Ajax**.
...
| Metric | Telstar — HOME | SC Cambuur — AWAY |
| --- | ---: | ---: |
| Matches (N) | 2 | 2 |
| W-D-L | 0-0-2 | 0-0-2 |
...
| GA/game | 3.50 | 4.00 |
| xG/game | 1.12 | 1.99 |
| xGA/game | 1.89 | 1.61 (overall fallback) |
| Shots/game | 7.5 (current overall) | 13.3 (current overall) |
| SOT/game | 2.0 (current overall) | 4.3 (current overall) |
| Shots allowed/game | 16.0 (overall fallback) | 15.0 (overall fallback) |
| SOT allowed/game | 6.0 (overall fallback) | 5.0 (overall fallback) |
| Possession | 47% (overall fallback) | 49% (overall fallback) |
| Corners for/game | 5.5 (overall fallback) | 6.0 (current overall) |
| Corners against/game | 6.8 (overall fallback) | 7.0 (current overall) |
| Total corners/game | 12.3 | 13.0 |
| First to score | 0% (current overall fallback) | 25% (current overall fallback) |
| First to concede | 100% (current overall fallback) | 75% (current overall fallback) |
| Scored in 1st half | 0% (current overall fallback) | 25% (current overall fallback) |
| Conceded in 1st half | 50% (current overall fallback) | 75% (current overall fallback) |
| BTTS | 50% | 50% |
| Clean sheets | 0% | 0% |
...
`
  ...
  sources: [
    {
      name: "fbref",
      url: "https://fbref.com/en/stathead/matchup/teams/9babc1f9/5c9e307a/Telstar-vs-Cambuur-History?utm_source=chatgpt.com",
      description: "Editorial source cited in the approved supplied analysis.",
      accessedAt: "2026-08-31T12:00:00.000Z"
    },
    {
      name: "soccerpunter",
      url: "https://www.soccerpunter.com/head-to-head-stats/home/23627/1550/1435/Telstar-vs-SC-Cambuur-in-Netherlands-Eerste-Divisie-2024-2025?utm_source=chatgpt.com",
      description: "Editorial source cited in the approved supplied analysis.",
      accessedAt: "2026-08-31T12:00:00.000Z"
    },
    {
      name: "worldsoccerdata",
      url: "https://www.worldsoccerdata.com/stats/netherlands/erste-divisie/matches/cambuur-vs-telstar-31-01-2025?utm_source=chatgpt.com",
      description: "Editorial source cited in the approved supplied analysis.",
      accessedAt: "2026-08-31T12:00:00.000Z"
    }
  ],
