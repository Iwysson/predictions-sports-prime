...
export const angersVsLille: EditorialPrediction = {
  ...
  "Four matches, four Lille victories, four clean sheets and zero Angers goals provide one of the strongest opponent-specific arguments supporting our selection.",
