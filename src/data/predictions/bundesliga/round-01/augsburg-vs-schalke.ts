...
export const augsburgVsSchalke: EditorialPrediction = {
  league: "bundesliga",
  homeTeam: "Augsburg",
  awayTeam: "Schalke 04",
  analysis: [
    "Augsburg host Schalke 04 in Bundesliga. This preview is intentionally limited to the verified fixture and the structure of the supplied editorial selection: Augsburg or Draw (1X) + Under 4.5 Goals.",
    ...
    "The selection is match-specific because it assigns the relevant protection, scoring line, or winning requirement to Augsburg and Schalke 04 exactly as shown. It should be assessed as one complete betting position rather than as a claim that either side is certain to produce a particular performance.",
  ...
  picks: {
    main: "Augsburg or Draw (1X) + Under 4.5 Goals",
    odds: 1.7,
    oddsProvenance: {
      source: "Betano — author-attested editorial capture",
      bookmaker: "Betano",
      provenance: "author_attested",
      capturedAt: "2026-08-24T12:24:00-03:00",
      market: "Augsburg or Draw (1X) + Under 4.5 Goals",
    },
  },
