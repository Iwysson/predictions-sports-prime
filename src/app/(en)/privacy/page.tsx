  ...
  return (
    <LegalPage
      ...
      sections={[
        ...
        { title: "Advertising and consent", content: <p>Advertising is fail-closed: the site starts advertising and analytics consent in a denied state, and AdSense units are not loaded unless advertising is deliberately enabled, valid publisher credentials are present, and the production deployment confirms that a Google-certified consent management platform is configured. The certified CMP remains responsible for collecting and communicating consent where required.</p> },
