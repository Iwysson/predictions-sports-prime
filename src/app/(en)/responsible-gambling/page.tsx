  ...
  return (
    <LegalPage
      ...
      sections={[
        ...
        { title: "Finding support", content: <><p>Use official or professionally verified support organisations in your country. Established examples include <a className="legal-link" href="https://www.begambleaware.org/" rel="noopener noreferrer" target="_blank">BeGambleAware</a> and <a className="legal-link" href="https://www.gamcare.org.uk/" rel="noopener noreferrer" target="_blank">GamCare</a> (United Kingdom), the <a className="legal-link" href="https://www.ncpgambling.org/" rel="noopener noreferrer" target="_blank">National Council on Problem Gambling</a> (United States) and <a className="legal-link" href="https://www.gamblersanonymous.org/" rel="noopener noreferrer" target="_blank">Gamblers Anonymous</a> (international). Check each organisation's site for the helpline that applies where you live.</p><p>If you feel at immediate risk, contact your local emergency service.</p></> },
      ]}
    />
  );
}
