...
export default function MethodologyPage() {
  return <><JsonLd data={institutionalPageJsonLd("WebPage", "Predictions Sports Prime methodology", "/methodology/", description)} /><LegalPage titleKey="about" heading="Our methodology" intro="How an individual pre-match assessment becomes a published analysis on Predictions Sports Prime." sections={[
    ...
    { title: "Statistics, context and weighting", content: <><p>Reliable xG and xGA data may be considered when available, alongside market odds, implied probability and comparisons between markets. No statistic automatically determines a pick. Sample size, quality of opposition, tactical matchup, schedule and the possibility that historical trends do not continue are weighed together.</p><p>Head-to-head records and historical probabilities describe past observations; they are not forecasts with certainty. Small samples and uneven opponents can make an apparently strong percentage misleading.</p></> },
