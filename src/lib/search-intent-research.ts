...
export const localeSearchResearch: Record<SearchLocale, LocaleSearchResearch> = {
  ...
  de: {
    ...
    markets: { ASIAN_HANDICAP: "asiatisches Handicap", OVER_UNDER: "Über/Unter Tore", BTTS: "beide Teams treffen", DOUBLE_CHANCE: "Doppelte Chance", CORNERS: "Ecken", DRAW_NO_BET: "Unentschieden ohne Wette", WIN: "Spielsieger", COMBINED: "Kombiwette" },
  },
  it: {
    status: "RESEARCHED", confidence: "HIGH_CONFIDENCE", sources: serpAndConvention, separator: "vs",
    ...
    markets: { ASIAN_HANDICAP: "handicap asiatico", OVER_UNDER: "più/meno gol", BTTS: "gol/no gol", DOUBLE_CHANCE: "doppia chance", CORNERS: "calci d'angolo", DRAW_NO_BET: "pareggio rimborso", WIN: "vincente partita", COMBINED: "scommessa combinata" },
  },
  nl: {
    status: "RESEARCHED", confidence: "HIGH_CONFIDENCE", sources: serpAndConvention, separator: "vs",
    ...
    markets: { ASIAN_HANDICAP: "Aziatische handicap", OVER_UNDER: "meer/minder doelpunten", BTTS: "beide teams scoren", DOUBLE_CHANCE: "dubbele kans", CORNERS: "hoekschoppen", DRAW_NO_BET: "gelijkspel zonder inzet", WIN: "wedstrijdwinnaar", COMBINED: "combinatieweddenschap" },
  },
  tr: {
