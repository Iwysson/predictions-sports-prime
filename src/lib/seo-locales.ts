...
export const seoLocales: Record<SeoLocaleSlug, LocaleCopy> = {
  ...
  it: {
    htmlLang: "it", displayName: "Italiano",
    homeTitle: "Pronostici Calcio Oggi e Analisi Partite | Predictions Sports Prime",
    homeDescription: "Pronostici di calcio, quote e analisi per le partite di oggi, domani e i prossimi incontri.",
    homeH1: "Pronostici Calcio Oggi e Analisi Partite",
    homeIntro: "Consulta pronostici indipendenti pubblicati prima delle partite, con quote registrate, analisi e risultati conservati.",
    today: "Pronostici di oggi", tomorrow: "Pronostici di domani", upcoming: "Prossimi pronostici",
    leagues: "Campionati", methodology: "Metodologia", results: "Risultati", viewAnalysis: "Vedi analisi",
    matchAnalysis: "Analisi della partita", mainPrediction: "Pronostico principale", odds: "Quote", published: "Pubblicato",
    sources: "Fonti e dati", responsible: "Contenuto solo informativo. Gioca responsabilmente e solo dove consentito dalla legge.",
    leagueTitle: (league) => `Pronostici ${league} e Quote | Predictions Sports Prime`,
    leagueDescription: (league) => `Pronostici, quote e analisi pubblicate per le partite di ${league}.`,
    leagueIntro: (league) => `Questo hub raccoglie le analisi editoriali pubblicate per ${league}, con pronostici, quote registrate e rischi descritti prima della partita.`,
    leagueMethodology: "Ogni analisi viene preparata prima della partita considerando forma, contesto, rendimento in casa e trasferta e mercato quando sono disponibili fonti adeguate. Nessun elemento garantisce il risultato.",
    matchTitle: (home, away) => `${home} vs ${away}: Pronostico e Quote | Predictions Sports Prime`,
    matchH1: (home, away) => `${home} vs ${away}: Pronostico e Analisi`,
    matchDescription: (home, away, league) => `Pronostico ${home} vs ${away}, analisi della partita e quote pubblicate per questo incontro di ${league}.`,
    separator: "vs",
  },
  nl: {
    htmlLang: "nl", displayName: "Nederlands",
    homeTitle: "Voetbal Voorspellingen Vandaag & Wedtips | Predictions Sports Prime",
    homeDescription: "Voetbalvoorspellingen, wedtips, odds en wedstrijdanalyses voor vandaag, morgen en komende duels.",
    homeH1: "Voetbal Voorspellingen Vandaag & Wedtips",
    homeIntro: "Bekijk onafhankelijke voorspellingen die vóór de aftrap zijn gepubliceerd, met vastgelegde odds, analyses en bewaarde resultaten.",
    today: "Voorspellingen vandaag", tomorrow: "Voorspellingen morgen", upcoming: "Komende voorspellingen",
    leagues: "Competities", methodology: "Methodologie", results: "Resultaten", viewAnalysis: "Bekijk analyse",
    matchAnalysis: "Wedstrijdanalyse", mainPrediction: "Hoofdvoorspelling", odds: "Odds", published: "Gepubliceerd",
    sources: "Bronnen en gegevens", responsible: "Alleen informatieve inhoud. Speel verantwoord en uitsluitend waar dit wettelijk is toegestaan.",
    leagueTitle: (league) => `${league} Voorspellingen & Wedtips | Predictions Sports Prime`,
    leagueDescription: (league) => `Bekijk voorspellingen, wedtips en analyses voor wedstrijden in de ${league}.`,
    leagueIntro: (league) => `Deze hub verzamelt gepubliceerde analyses voor de ${league}, met voorspellingen, vastgelegde odds en vooraf beschreven risico's.`,
    leagueMethodology: "Elke analyse wordt vóór de aftrap afzonderlijk opgesteld. Recente vorm, competitiecontext, thuis- en uitprestaties en marktprijzen kunnen worden meegewogen wanneer geschikte bronnen beschikbaar zijn. Geen factor garandeert een uitslag.",
    matchTitle: (home, away) => `${home} vs ${away}: Voorspelling & Odds | Predictions Sports Prime`,
    matchH1: (home, away) => `${home} vs ${away}: Voorspelling en Analyse`,
    matchDescription: (home, away, league) => `Bekijk de voorspelling voor ${home} vs ${away}, wedstrijdanalyse en gepubliceerde odds voor dit duel in de ${league}.`,
    separator: "vs",
  },
  tr: {
    htmlLang: "tr", displayName: "Türkçe",
    homeTitle: "Bugünün Futbol Tahminleri ve Maç Analizleri | Predictions Sports Prime",
    homeDescription: "Bugün, yarın ve yaklaşan maçlar için futbol tahminleri, bahis oranları ve maç analizleri.",
    homeH1: "Bugünün Futbol Tahminleri ve Maç Analizleri",
    homeIntro: "Maçlardan önce yayımlanan bağımsız tahminleri; kayıtlı oranlar, analizler ve korunan sonuçlarla inceleyin.",
    today: "Bugünün tahminleri", tomorrow: "Yarının tahminleri", upcoming: "Yaklaşan tahminler",
    leagues: "Ligler", methodology: "Metodoloji", results: "Sonuçlar", viewAnalysis: "Analizi gör",
    matchAnalysis: "Maç analizi", mainPrediction: "Ana tahmin", odds: "Oranlar", published: "Yayımlandı",
    sources: "Kaynaklar ve veriler", responsible: "İçerik yalnızca bilgilendirme amaçlıdır. Sorumlu oynayın ve yalnızca yasal olduğu yerlerde bahis yapın.",
    leagueTitle: (league) => `${league} Tahminleri ve Bahis Oranları | Predictions Sports Prime`,
    leagueDescription: (league) => `${league} maçları için yayımlanan tahminleri, oranları ve analizleri inceleyin.`,
    leagueIntro: (league) => `Bu merkez ${league} için yayımlanan analizleri; tahminler, kayıtlı oranlar ve maç öncesi belirtilen risklerle bir araya getirir.`,
    leagueMethodology: "Her analiz maç başlamadan önce ayrı ayrı hazırlanır. Uygun kaynaklar bulunduğunda güncel form, lig bağlamı, iç saha ve deplasman performansı ile piyasa fiyatı dikkate alınabilir. Hiçbir unsur sonucu garanti etmez.",
    matchTitle: (home, away) => `${home} vs ${away}: Maç Tahmini ve Oranlar | Predictions Sports Prime`,
    matchH1: (home, away) => `${home} vs ${away}: Maç Tahmini ve Analizi`,
    matchDescription: (home, away, league) => `${league} kapsamındaki ${home} vs ${away} maçı için tahmin, analiz ve yayımlanan oranları inceleyin.`,
    separator: "vs",
  },
};
